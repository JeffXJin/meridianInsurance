...
import LifeImage from '../imgs/life.jpg'
    ...
    return (
      <div className={'container'}>
        ...
        <div class="imageContainer">
          <div>
            <img className="lifeImage" src={LifeImage}/>
          </div>
          <div className="centered"><h1 className='lifeText'>Life</h1></div>
        </div>
        <div className={'row'}>
          <div className={'col-xs-12'}>
            <p>
                Please call Yan Li at (604) 941-8544 for more information about Life Insurance and Financial Planning.            </p>
            <h3>
        ...
        <div className='contactSection'>
            ...
            <p><span className='contactSectionLink'><Link classname='user' to='/contact'>Contact Us</Link></span> or <span className='contactSectionLink'><Link classname='user' to='/book'>Book an appointment</Link></span> today and our qualified staff can assist you in calculating the current rebuilding cost of your home and help you to choose the type of policy that best suits your needs.</p>
        </div>
        </div>
      </div>
    );
